<html><body>
    <?php //!!Getting the type is very difficult and requires many special exceptions!!
        //Settings
                ...
                for ($page = 1; $page <= $limitP; $page++) {
                    ...
                    foreach ($laws as $law) {
                        ...
                        if ($result->num_rows > 0) {
                            ...
                            //Creates SQL
                            $SQL2 = "INSERT INTO `".strtolower($scraper)."`(`enactDate`, `enforceDate`, `lastactDate`, `savedDate`, `ID`, `name`, `country`, `regime`, `origin`, `type`, `status`, `source`)
                                    VALUES ('".$enactDate."', '".$enforceDate."', '".$lastactDate."', '".date('Y-m-d')."', '".$ID."', '".$name."', '".$country."', '"./*$regime."', ".*/$origin.", '".$type."', '".$status."', '".$source."')";
                        }
