    ...
    <?php
        ...
        for ($offset = $start; $offset <= $limit; $offset += $step) {
            ...
            foreach ($API_Call($offset)['hits']['hits'] as $law) {
                $enactDate = date('Y/m/d', strtotime($law['_source']['data']['attributes']['dateDocument']['xsd:date']));
