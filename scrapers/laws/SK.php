<?php //Slovakia
    ...
    $statuses = [//TODO: Incorporate types and origins into this
    ...
    $saveDate = date('Y-m-d'); $country = '["SK"]';
    $publisher = '{"sk":"Ministerstvo spravodlivosti Slovenskej republiky", "en":"The Ministry of Justice of the Slovak Republic"}';
    ...
    foreach ($laws as $law) {
        ...
        //Creates SQL
        $SQL2 = "INSERT INTO `".strtolower($scraper)."`(`enactDate`, `enforceDate`, `lastactDate`, `endDate`, `saveDate`, `ID`, `country`, `regime`, `publisher`, `name`, `type`, `status`, `source`) 
                VALUES ('".$enactDate."', '".$enforceDate."', '".$lastactDate."', ".$endDate.", '".$saveDate."', '".$ID."', '".$country."', '".$regime."', '".$publisher."', '".$name."', '".$type."', '".$status."', '".$source."')"; echo $SQL2.'<br/>';
