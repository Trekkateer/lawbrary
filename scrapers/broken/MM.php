<?php //Myanmar
    //!!The government website is currently not working!!
        ...
        foreach($body_rows as $row_num => $body_row) {
            ...
            if ($vals['Revision'] === '제정' || $vals['Revision'] === 'New Enactment') {
                ...
                if ($result->num_rows > 0) {
                    ...
                    //Creates SQL
                    $SQL2 = "INSERT INTO `".strtolower($scraper)."`(`enactDate`, `enforceDate`, `lastactDate`, `saveDate`, `ID`, `name`, `type`, `origin`, `status`, `source`)
